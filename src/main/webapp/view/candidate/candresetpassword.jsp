...
<body>
	...
	<div class="container">
		...
		<form action="/candidate/candresetpassword" method="post"
			class="row justify-content-center" autocomplete="off">
			<div class="col-md-6">
				<div class="form-group">
					<label for="uName" class="mb-1">User Name:</label> 
					<input type="hidden" name="userId" value="${SESSION1.candId}">
					 <input	type="text" name="userName" value="${SESSION1.candUserName}"
