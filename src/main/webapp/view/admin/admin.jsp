...
<body>
	...
	<div class="fluid-container">
		<div class="p-2 table-primary border border-dark">
			<span class="p-2"> Admin Edit </span>
			<c:forEach items="${OTHERMENUS}" var="menus" begin="0" end="4">
		...
		<div class="row justify-content-center py-5">
			<div class="col-md-3 table-primary p-0 mx-3 border border-secondory">
				<h5 class="bg-secondary text-white text-center py-2">Important
					All Links</h5>
				<div class="row">
			...
			<div class="col-md-3 bg-light p-0 mx-3 border border-secondory">
				...
				<div class="row">
					...
					<c:if test="${UNCOMPLETEQUESTION > 0 }">
						<div class="col-md-12">
							<span class="p-2"><a
								class="text-decoration-none text-danger"
					...
					<div class="col-md-12">
						<span class="p-2"><a
							...
							href="http://localhost:8080/${OTHERMENUS[10].iconLink}"> *
								${OTHERMENUS[10].iconText} (${TOTALCANDIDATE > 0 ? TOTALCANDIDATE : 0 })
						</a></span>
					</div>
					<hr>
					<div class="col-md-12">
						<span class="p-2"><a
							...
							href="http://localhost:8080/${OTHERMENUS[11].iconLink}"> *
								${OTHERMENUS[11].iconText} (${TOTALQUESTIONS > 0 ? TOTALQUESTIONS : 0  })
						</a></span>
					</div>
					<hr>
